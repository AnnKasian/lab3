package lab3.lab3.Controllers;

import lab3.lab3.CasdoorProperties;
...
public class AuthController {
    ...
    HttpServletRequest servletRequest,  // Renamed from request to servletRequest
    ...
    HttpEntity<MultiValueMap<String, String>> requestEntity = new HttpEntity<>(params, headers);  // Renamed from request to requestEntity
